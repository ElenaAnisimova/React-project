...
import { DataResponse } from '../components/SearchResults/SearchResultsTypes';
import { initialResponse } from '../components/SearchResults/SearchResultsTypes';
...
export function SearchPage() {
  ...
  // const { data, error, isLoading } = dataAPI.useFetchAllCharactersQuery({
  //   searchStr: query,
  //   limit,
  //   page: currentPage,
  // });
  ...
  // const queryCharacters = (searchStr: string, limit: number, page: number) => {
  //   return dataAPI.useFetchAllCharactersQuery({
  //     searchStr,
  //     limit,
  //     page,
  //   });
  ...
  // //  const responseJSON = queryCharacters(searchStr, limit, currentPage);
  ...
  //     const responseJSON = data as SearchCharactersResponse;
  //     if (!isLoading) {
